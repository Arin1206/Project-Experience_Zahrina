...
<body>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="range-slider-container">
                        <input type="range" min="30000" max="200000" step="10000" value="30000"
                            class="range-slider" id="myRange">
                        <div class="value-box" id="value">Rp.30.000</div>
                    </div>
                    <div class="advertise-card">
                        <h5 id="advertise-text" class="judul">Anda akan beriklan selama <strong>7 HARI</strong> dengan
                            <br> budget
                ...
                <div class="col-md-5 bg-oren">
                    <div class="form-check">
                        <label class="label">
                            <input type="radio" name="ad-type" value="ads-only" id="ads-only" onclick="updatePrice()"
                    ...
                    <div class="form-check">
                        <label>
                            <input type="radio" name="ad-type" value="ads-and-content" id="ads-and-content"
                                onclick="updatePrice()" class="form-check-input">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="total-price">
                                <span id="total-price">Rp.30,000</span>*
                            </div>
        ...
        <div id="14hari" class="container tab-pane">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="range-slider-container">
                        <input type="range" min="30000" max="200000" step="10000" value="30000"
                            class="range-slider" id="myRange2">
                        <div class="value-box" id="value2"> Rp.30.000</div>
                    </div>
                    <div class="advertise-card">
                        <h5 id="advertise-text2" class="judul">Anda akan beriklan selama <strong>14 HARI</strong> dengan
                            <br> budget
                            harian sebesar <strong>Rp30.000</strong>
                        </h5>
                    </div>
                ...
                <div class="col-md-5 bg-oren">
                    <div class="form-check">
                        <label class="label">
                            <input type="radio" name="ad-type" value="ads-only2" id="ads-only2" onclick="updatePrice2()"
                                class="form-check-input">
                            <h5><strong>Ads
                                    Only</strong></h5>
                    ...
                    <div class="form-check">
                        <label>
                            <input type="radio" name="ad-type" value="ads-and-content2" id="ads-and-content2"
                                onclick="updatePrice2()" class="form-check-input">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="total-price">
                                <span id="total-price2">Rp.30,000</span>*
                            </div>
                            <h6>*) Harga sudah termasuk jasa iklan</h6>
                        </div>
                        <div class="col-md-5">
        ...
        <div id="30hari" class="container tab-pane">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="range-slider-container">
                        <input type="range" min="30000" max="200000" step="10000" value="30000"
                            class="range-slider" id="myRange3">
                        <div class="value-box" id="value3"> Rp.30.000</div>
                    </div>
                    <div class="advertise-card">
                        <h5 id="advertise-text3" class="judul">Anda akan beriklan selama <strong>30 HARI</strong> dengan
                            <br> budget
                            harian sebesar <strong>Rp30.000</strong>
                        </h5>
                    </div>
                ...
                <div class="col-md-5 bg-oren">
                    <div class="form-check">
                        <label class="label">
                            <input type="radio" name="ad-type" value="ads-only3" id="ads-only3" onclick="updatePrice3()"
                                class="form-check-input">
                            <h5><strong>Ads
                                    Only</strong></h5>
                            <h6 style="font-weight:300px!important">Setiap langkah iklan Anda adalah langkah menuju kesuksesan yang lebih besar.</h6>
                    ...
                    <div class="form-check">
                        <label>
                            <input type="radio" name="ad-type" value="ads-and-content3" id="ads-and-content3"
                                onclick="updatePrice3()" class="form-check-input">
                            <h5><strong> Ads + Konten </strong></h5> <h6 style="font-weight:300px!important">Kami menyatukan iklan yang
                            memukau dengan konten yang menggugah minat.</h6>
                        </label>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="total-price">
                                <span id="total-price3">Rp.30,000</span>*
                            </div>
                            <h6>*) Harga sudah termasuk jasa iklan</h6>
                        </div>
                        <div class="col-md-5">
    ...
    <script>
      ...
      var advertiseText = document.getElementById("advertise-text");
      var radioAdsOnly = document.getElementById("ads-only");
      var radioAdsAndContent = document.getElementById("ads-and-content");
      ...
      function updateValuePosition() {
          var thumbWidth = slider.clientWidth * ((slider.value - slider.min) / (slider.max - slider.min));
          var offset = thumbWidth - (output.clientWidth / 2);
          output.style.left = offset + "px";
          output.textContent = "Rp." + numberWithCommas(slider.value);
      }

      function updateAdvertiseText() {
          var budget = "Rp." + numberWithCommas(slider.value);
          advertiseText.innerHTML = "Anda akan beriklan selama <strong>" + selectedTab + " HARI</strong> <br> dengan budget harian sebesar <strong>" + budget + "</strong>";
      }

      var selectedTab = 7; // Default selected tab is 7 Hari

      function selectTab(days) {
          selectedTab = days;
          slider.value = 30000; // Reset slider value to minimum
          slider.style.setProperty('--value', slider.value);
          updateValuePosition();
          updateAdvertiseText();
          updatePrice();
      ...
      var additionalPriceByDaysAdsOnly = {
          7: 250000,
          14: 300000,
          30: 450000
      };

      var additionalPriceByDaysAdsAndContent = {
          7: 300000,
          14: 400000,
          30: 450000
      };
      ...
      function updatePrice() {
          var basePrice = parseInt(slider.value);
          var selectedDays = selectedTab;
          var additionalPrice = 0;

          if (radioAdsOnly.checked) {
              additionalPrice = additionalPriceByDaysAdsOnly[selectedDays];
          } else if (radioAdsAndContent.checked) {
              additionalPrice = additionalPriceByDaysAdsAndContent[selectedDays];
          }

          var totalPriceValue = (selectedDays * basePrice) + additionalPrice;

          totalPrice.textContent = "Rp." + numberWithCommas(totalPriceValue);
      }
      ...
      function updateSliderStep() {
          slider.step = "10000"; // Tetapkan langkah slider ke 10.000
      }
  </script>
   <script>
    var slider2 = document.getElementById("myRange2");
    var output2 = document.getElementById("value2");
    var advertiseText2 = document.getElementById("advertise-text2");
    var radioAdsOnly2 = document.getElementById("ads-only2");
    var radioAdsAndContent2 = document.getElementById("ads-and-content2");
    var totalPrice2 = document.getElementById("total-price2");

    slider2.style.setProperty('--min', slider2.min);
    slider2.style.setProperty('--max', slider2.max);
    slider2.style.setProperty('--value', slider2.value);

    slider2.oninput = function() {
        slider2.style.setProperty('--value', this.value);
        updateValuePosition2();
        updateAdvertiseText2();
        updatePrice2();
        updateSliderStep2();
    };

    function updateValuePosition2() {
        var thumbWidth2 = slider2.clientWidth * ((slider2.value - slider2.min) / (slider2.max - slider2.min));
        var offset2 = thumbWidth2 - (output2.clientWidth / 2);
        output2.style.left = offset2 + "px";
        output2.textContent = "Rp." + numberWithCommas(slider2.value);
    }

    function updateAdvertiseText2() {
        var budget2 = "Rp." + numberWithCommas(slider2.value);
        advertiseText2.innerHTML = "Anda akan beriklan selama <strong>" + selectedTab2 + " HARI</strong> <br> dengan budget harian sebesar <strong>" + budget2 + "</strong>";
    }

    var selectedTab2 = 14; // Default selected tab is 7 Hari

    function selectTab(days) {
        selectedTab2 = days;
        slider2.value = 30000; // Reset slider value to minimum
        slider2.style.setProperty('--value', slider2.value);
        updateValuePosition2();
        updateAdvertiseText2();
        updatePrice2();
    ...
    var additionalPriceByDaysAdsOnly2 = {
        7: 250000,
        14: 300000,
        30: 450000
    };

    var additionalPriceByDaysAdsAndContent2 = {
        7: 300000,
        14: 400000,
        30: 450000
    };
    ...
    function updatePrice2() {
        var basePrice2 = parseInt(slider2.value);
        var selectedDays2 = selectedTab2;
        var additionalPrice2 = 0;

        if (radioAdsOnly2.checked) {
            additionalPrice2 = additionalPriceByDaysAdsOnly2[selectedDays2];
        } else if (radioAdsAndContent2.checked) {
            additionalPrice2 = additionalPriceByDaysAdsAndContent2[selectedDays2];
        }

        var totalPriceValue2 = (selectedDays2 * basePrice2) + additionalPrice2;

        totalPrice2.textContent = "Rp." + numberWithCommas(totalPriceValue2);
    }
    ...
    function updateSliderStep2() {
        slider2.step = "10000"; // Tetapkan langkah slider ke 10.000
    }
</script>
<script>
    var slider3 = document.getElementById("myRange3");
    var output3 = document.getElementById("value3");
    var advertiseText3 = document.getElementById("advertise-text3");
    var radioAdsOnly3 = document.getElementById("ads-only3");
    var radioAdsAndContent3 = document.getElementById("ads-and-content3");
    var totalPrice3 = document.getElementById("total-price3");

    slider3.style.setProperty('--min', slider3.min);
    slider3.style.setProperty('--max', slider3.max);
    slider3.style.setProperty('--value', slider3.value);

    slider3.oninput = function() {
        slider3.style.setProperty('--value', this.value);
        updateValuePosition3();
        updateAdvertiseText3();
        updatePrice3();
        updateSliderStep3();
    };

    function updateValuePosition3() {
        var thumbWidth3 = slider3.clientWidth * ((slider3.value - slider3.min) / (slider3.max - slider3.min));
        var offset3 = thumbWidth3 - (output3.clientWidth / 2);
        output3.style.left = offset3 + "px";
        output3.textContent = "Rp." + numberWithCommas(slider3.value);
    }

    function updateAdvertiseText3() {
        var budget3 = "Rp." + numberWithCommas(slider3.value);
        advertiseText3.innerHTML = "Anda akan beriklan selama <strong>" + selectedTab3 + " HARI</strong> <br> dengan budget harian sebesar <strong>" + budget3 + "</strong>";
    }

    var selectedTab3 = 30; // Default selected tab is 7 Hari

    function selectTab(days) {
        selectedTab3 = days;
        slider3.value = 30000; // Reset slider value to minimum
        slider3.style.setProperty('--value', slider3.value);
        updateValuePosition3();
        updateAdvertiseText3();
        updatePrice3();
    ...
    var additionalPriceByDaysAdsOnly3 = {
        7: 250000,
        14: 300000,
        30: 450000
    };

    var additionalPriceByDaysAdsAndContent3 = {
        7: 300000,
        14: 400000,
        30: 450000
    };
    ...
    function updatePrice3() {
        var basePrice3 = parseInt(slider3.value);
        var selectedDays3 = selectedTab3;
        var additionalPrice3 = 0;

        if (radioAdsOnly3.checked) {
            additionalPrice3 = additionalPriceByDaysAdsOnly3[selectedDays3];
        } else if (radioAdsAndContent3.checked) {
            additionalPrice3 = additionalPriceByDaysAdsAndContent3[selectedDays3];
        }

        var totalPriceValue3 = (selectedDays3 * basePrice3) + additionalPrice3;

        totalPrice3.textContent = "Rp." + numberWithCommas(totalPriceValue3);
    }
    ...
    function updateSliderStep3() {
        slider3.step = "10000"; // Tetapkan langkah slider ke 10.000
    }
</script>
</body>
...
<body>
    ...
    <ul class="nav nav-pills2 judultab2" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" data-bs-toggle="pill" href="#7hari2" onclick="selectTab(7)">7 Hari</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="pill" href="#14hari2" onclick="selectTab(14)">14 Hari</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="pill" href="#30hari2" onclick="selectTab(30)">30 Hari</a>
        </li>
    </ul>
    ...
    <div class="tab-content">
        <div id="7hari2" class="container tab-pane active">
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h4 class="judultab3">Budget Harian:</h4>
    ...
    <div class="tab-content">
        <div id="14hari2" class="container tab-pane">
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h4 class="judultab3">Budget Harian:</h4>
    ...
    <div class="tab-content">
        <div id="30hari2" class="container tab-pane">
            <div class="row">
                <div class="col-sm-6">
                    <br>
                    <h4 class="judultab3">Budget Harian:</h4>
...
<?php /**PATH C:\xampp\htdocs\coba2\resources\views/ads2.blade.php ENDPATH**/ ?>